...
class stress_state():
    ...
    def normal_and_shear_stress(self):
        ...
        for idp, phi in enumerate(range(90,181,self.increment)):
            ...
            for idt, theta in enumerate(range(0,361,self.increment)):
                ...
                [stress_fracture, dc_stress_fracture, R] = shearonplane(self.stress_tensor, trend_s1_rad, plunge_s1_rad, trend_s3_rad, strike, dip) 
    ...
    def stereonet_plot(self, dataset, dataset_name='dataset_name'):
